function [result, thinnedOrientation] = calc_thinning(matrix, oriensMatrix, oriensMatrixIndex, thin)
% VERSION 5/1/04
...
if (thin == 1) 
  [result, thinnedOrientation] = thinning(matrix, oriensMatrix, oriensMatrixIndex, 2);
else
  result = matrix;
end